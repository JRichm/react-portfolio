    ...
    <div className="flex flex-col border p-5 gap-3 rounded">
      ...
      <div className='flex flex-row gap-5'>
        ...
        <div className='flex flex-col gap-3 w-[500px]'>
            ...
            <input type="button" value="View Project" className="self-end border mt-auto border-black rounded w-fit px-5 py-1 bg-black text-white hover:text-black hover:bg-transparent transition-all hover:cursor-pointer" />
        </div>
      </div>
    </div>
  );
